...
class Juego {
  ...
  ganoJuego() {
    swal('Felicitaciones', 'Ganaste el juego, puntuacion: ' + (this.nivel - 1), 'success')
      .then(() => {
        this.inicializar()
      })
  }
  ...
  PerdioJuego() {
    swal('Lo sentimos', 'Perdiste el juego, puntuacion: ' + (this.nivel - 1), 'error')
      .then(() => {
        this.eliminarEventosClick()
        this.inicializar()
      })
